...
//This is a rendition of what I did at my course at saddleback
public class Tic_Tac_Toe {

    public static ArrayList<String> loosingCombinations = new ArrayList<String>();
   ...
   ********************************************************************************************/ 
    ...
    // Horizontal check - row 0, row 1, row 2
        ...
        if(win) {
            ...
            loosingCombinations.add(currentBoard);
        }
        return win;
    }
}
